...
ifdef BOARD_HAS_MTK
RECOVERY_VERSION := $(RECOVERY_NAME) v1.4-mtk
else
RECOVERY_VERSION := $(RECOVERY_NAME) v1.4
endif
...
BOARD_RECOVERY_DEFINES := BOARD_RECOVERY_SWIPE BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY RECOVERY_EXTEND_NANDROID_MENU TARGET_USE_CUSTOM_LUN_FILE_PATH TARGET_DEVICE TARGET_RECOVERY_FSTAB BOARD_HAS_MTK BOARD_RECOVERY_SWAPXY
